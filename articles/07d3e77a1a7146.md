...
- [AddVoidReturnTypeWhereNoReturnRector](https://github.com/rectorphp/rector/blob/2.0.9/docs/rector_rules_overview.md#addvoidreturntypewherenoreturnrector)
    - メソッドの返す型に`void`が付いていない場合に付けるルール

- [AddTestsVoidReturnTypeWhereNoReturnRector](https://github.com/rectorphp/rector/blob/2.0.9/docs/rector_rules_overview.md#addtestsvoidreturntypewherenoreturnrector)
